...
### full df
```{r}
sf_df %>% full_join(silo_regions) #note there will be NAs introduced as some years there were no recording/reportings of sclerotia at particular silo points.
```
...
sb_2014_6 <- read_xlsx("data/soyabean/soya_part_6_2013_2014.xls.xlsx")
